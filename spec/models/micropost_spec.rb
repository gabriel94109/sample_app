...
describe Micropost do
  ...
  describe "from_users_followed_by" do
    before(:each) do
      ...
      @other_post = @user.microposts.create!(:content => 'bar')
      @third_post = @user.microposts.create!(:content => 'baz')
    ...
    it "should not include an unfollowed users microposts" do
      Micropost.from_users_followed_by(@user).should include(@third_post)
    end
  end
end
